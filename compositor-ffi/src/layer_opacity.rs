...
#[unsafe(no_mangle)]
pub extern "C" fn compositor_opacity_layer_new() -> *mut ValueBox<Arc<dyn Layer>> {
    ValueBox::new(Arc::new(OpacityLayer::new()) as Arc<dyn Layer>).into_raw()
}

#[unsafe(no_mangle)]
pub extern "C" fn compositor_opacity_layer_new_alpha(alpha: f32) -> *mut ValueBox<Arc<dyn Layer>> {
